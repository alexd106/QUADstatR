...
2. If you haven't already download the data file *‘whaledata.xls’* from the **[<i class="fa fa-download"></i> Data](data.html)** link and save it to the `data` directory you created in Exercise 1.  
