...
## Core Software
**Install R.** Install the latest version of R (**R version `r paste(R.Version()$major, ".", R.Version()$minor, sep="")`**). Download and install R for [Windows](http://cran.r-project.org/bin/windows/base/){target="_blank"},  [Mac](http://cran.r-project.org/bin/macosx/){target="_blank"} (download the latest R-3.x.x.pkg file for your appropriate version of Mac OS) or [linux](https://cran.r-project.org/bin/linux){target="_blank"} (choose your flavour of linux).
...
See Section 1.1 and 1.2 of our [Introduction to R book](https://intro2r.com) for more details about installing R and RStudio. We have also produced a couple of videos containing step by step instructions for installing R and RStudio and also RStudio orientation.
